...
def ds_cscan():
    return render_template('disk_scheduling/cscan.html')

@app.route('/disk-scheduling/fcfs', methods=['GET'])
def ds_fcfs():
    return render_template('disk_scheduling/fcfs.html')

@app.route('/disk-scheduling/scan', methods=['GET'])
def ds_scan():
    return render_template('disk_scheduling/scan.html')
...
def fa_indexed():
    return render_template('file_allocation/indexed.html')

@app.route('/file-allocation/linked', methods=['GET'])
def fa_linked():
    return render_template('file_allocation/linked.html')

@app.route('/file-allocation/sequential', methods=['GET'])
def fa_sequential():
    return render_template('file_allocation/sequential.html')
...
def mvt_best_fit():
    return render_template('memory_allocation/mvt/best_fit.html')

@app.route('/memory-allocation/mvt/first-fit', methods=['GET'])
def mvt_first_fit():
    return render_template('memory_allocation/mvt/first_fit.html')

@app.route('/memory-allocation/mvt/worst-fit', methods=['GET'])
def mvt_worst_fit():
    return render_template('memory_allocation/mvt/worst_fit.html')
